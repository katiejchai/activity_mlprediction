...
```{r, libraries}
library(tidyverse); library(caret); library(parallel); library(doParallel)
...
The final predictions for the classes for the 20 observations in the validation set, based on the random forest model, are shown below. The expected out-of-sample accuracy has a 95% confidence interval of 99.13% to 99.5%.
